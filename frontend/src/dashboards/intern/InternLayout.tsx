...
import InternLeavesPage from "./InternLeavesPage";
...
export default function InternLayout() {
  ...
  const links = [
    { to: "/intern", label: "Dashboard", icon: DashboardSvg, isSvg: true },
    { to: "/intern/leaves", label: "Leaves", icon: LeavesSvg, isSvg: true },
  ];
